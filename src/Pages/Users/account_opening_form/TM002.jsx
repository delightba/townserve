...
const TM002 = () => {
  ...
  const loadFormDataFromSessionStorageTM002Mandates = () => {
    const storedFormData = sessionStorage.getItem(
      sessionStorageKeyTM002Mandates
    );
    return storedFormData ? JSON.parse(storedFormData) : null;
  };
  ...
  const [mandate, setMandate] = useState(
    loadFormDataFromSessionStorageTM002() || {
      branch: "",
      account_type: "",
      account_number: "",
      account_name: "",
  ...
  const [mandates, setMandates] = useState(
    loadFormDataFromSessionStorageTM002Mandates() || [
      {
        residential_address: "",
        telephone: "",
        dob: "",
  ...
  const handleNokInputChange = (index, field, value) => {
    ...
    if (
      index >= 0 &&
      index < updatedMandates.length &&
      "nok" in updatedMandates[index]
    ) {
      const uppercaseValue = value.toUpperCase();
  ...
  const handleMandateDetailsInputChange = (index, field, value) => {
    ...
    if (
      index >= 0 &&
      index < updatedMandates.length &&
      "mandate_details" in updatedMandates[index]
    ) {
      const uppercaseValue = value.toUpperCase();
    ...
    <div className="px-4 py-8 w-full lg:max-w-[90%] mx-auto">
      <div className="flex justify-between gap-3">
        <div className=" w-full">
          ...
          <h1 className="text-2xl font-bold text-green-600">
            Account Signature/Mandate Card
          </h1>
        </div>
      ...
      <section>
        <form>
                ...
                <div key={index} className="mt-4">
                  ...
                  <article className="flex flex-col md:flex-row gap-2 my-1">
                    <CustomInput
                      ...
                      handleChange={(e) =>
                        handleNokInputChange(index, "name", e.target.value)
                      }
                    />
                    <CustomInput
                      name={"gsm"}
                      ...
                      label={"GSM"}
                      handleChange={(e) =>
                        handleNokInputChange(index, "gsm", e.target.value)
                      }
                    />
                  </article>
                  <article className="flex flex-col md:flex-row gap-2 my-1">
                  ...
                  <article className="flex flex-col md:flex-row gap-2 my-1">
                    <CustomInput
                      ...
                      label={"Address:"}
                      handleChange={(e) =>
                        handleNokInputChange(index, "address", e.target.value)
                      }
                    />
                  ...
                  <div className="my-6 p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                      <div>
                        <CustomInput
                          ...
                          label={"Name(s):"}
                          handleChange={(e) =>
                            handleMandateDetailsInputChange(
                              index,
                              "name",
                              e.target.value
                            )
                    ...
                    {/* Address Input using CustomInput Component */}
                    <div className="mt-4">
                      <CustomInput
                        name={"address"}
                        type={"text"}
                  ...
                  <section className="mt-3 flex flex-col gap-3">
                    <div className="border-b">
                      ...
                      <input
                        ...
                        accept="image/*"
                        onChange={(e) =>
                          handleFileUpload(index, "signature", e)
                        }
                        className="hidden"
                    ...
                    <div className="border-b">
                      ...
                      <input
                        ...
                        accept="image/*"
                        onChange={(e) =>
                          handleFileUpload(index, "passport_photograph", e)
                        }
                        className="hidden"
                      ...
                      {/* Display area for the image */}
                      <label
                        htmlFor={`passportPhotographInput${index}`}
                        className="relative block cursor-pointer"
                      >
          ...
          <button type="button" onClick={addMandate} className="next">
            Add Mandate
          </button>
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row gap-2 my-3">
              <CustomInput
                ...
                type={"checkbox"}
                value={mandate.stamp}
                label={"Stamp/Seal required:"}
                handleChange={handleCheckboxChange}
              />
              <CustomInput
                name={"ao_initial"}
                type={"checkbox"}
                value={mandate.ao_initial}
                label={"A/O initial/date:"}
                handleChange={handleCheckboxChange}
              />
            </div>
            <div className="flex flex-col md:flex-row gap-2 my-3">
