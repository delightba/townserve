  ...
  return (
    <div ref={targetRef} className='p-[100px] shadow-xl w-full xl:w-[60%] mx-auto'>
      ...
      <section>
        ...
        <p className='text-lg font-medium'>We write further to your recent telephone discussion with Mr Odusanmi on your interest in our products and we wish to make our offer thus:</p>
      ...
      <section className='flex justify-between items-end my-4'>
        <div>
          <article>
            ...
            <br />
            <figure>
              <img src={details.signature} alt="" className='w-[200px] object-contain'/>
            </figure>
