...
const Form = ({details, handleChange, handleSubmit}) => {
 ...
 return (
  <form className='flex flex-col gap-3'>
   <div>
    <h1 className='greenheader text-center'>TownServe Investment Note Form</h1>
   ...
   <section>
    ...
    <CustomInput value={details.rate} placeholder={"Your rate percent"} name={"rate"} type={"text"} label={"Rate"} handleChange={handleChange} />
    <CustomInput value={details.tenor} placeholder={"Your tenor here"} name={"tenor"} type={"text"} label={"Tenor"} handleChange={handleChange} />
    ...
    <CustomInput value={details.value_at_maturity} placeholder={"Your matured value"} name={"value_at_maturity"} type={"number"} label={"Matured value"} handleChange={handleChange} />
